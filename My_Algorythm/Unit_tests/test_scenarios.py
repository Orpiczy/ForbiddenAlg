from ClassesReqByAlgorithm import Pv, Battery
...
class Scenarios:
    def __init__(self):
        ...
        pv1 = Pv(11, 5100, 3100, 0.3, 1.5)  # cena jest druga
        pv2 = Pv(12, 6530, 4000, 0.3, 1.5)  # def __init__(self, id, price, power, efficiency, area, quantity=0):
        pv3 = Pv(13, 7800, 4500, 0.3, 1.5)
        pv4 = Pv(14, 9000, 4600, 0.3, 1.5)
        ...
        p1 = Pv(11, 5100, 3100, 0.3, 1.5)  # cena jest druga
        p2 = Pv(12, 6530, 4000, 0.3, 1.5)  # def __init__(self, id, price, power, efficiency, area, quantity=0):
        p3 = Pv(13, 7800, 4500, 0.3, 1.5)
        p4 = Pv(14, 9000, 4600, 0.3, 1.5)
        ...
        p1 = Pv(11, 5100, 3610, 0.3, 1.5)  # def __init__(self, id, price, power, efficiency, area, quantity=0):
        p2 = Pv(12, 6530, 3000, 0.3, 1.5)
        p3 = Pv(13, 7800, 3500, 0.3, 1.5)
        p4 = Pv(14, 9000, 3600, 0.3, 1.5)
